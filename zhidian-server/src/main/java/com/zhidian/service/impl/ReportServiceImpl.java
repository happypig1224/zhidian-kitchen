...
import com.zhidian.service.WorkspaceService;
import com.zhidian.vo.*;
...
public class ReportServiceImpl implements ReportService {
    ...
    public TurnoverReportVO getTurnOver(LocalDate begin, LocalDate end) {
        ...
        System.out.println("turnoverList = " + turnoverList);
    ...
    public OrderReportVO getOrderStatistics(LocalDate begin, LocalDate end) {
        ...
        //时间区间内订单总数
        Integer orderCount = orderCountList.isEmpty() ? 0 : orderCountList.stream().reduce(Integer::sum).get();
        //时间区间内有效订单总数
        Integer validOrderCount = validOrderCountList.isEmpty() ? 0 : validOrderCountList.stream().reduce(Integer::sum).get();
